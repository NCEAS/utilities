/**
 *  '$RCSfile: KeyFileExistsException.java,v $'
...
/**
 * Exception thrown when an error occurs because an encryption key
 * file was being created when one already existed.
 *
 */
public class KeyFileExistsException extends Exception {
   ...
   */
  public KeyFileExistsException(String message) {
    super(message);
  }
}
