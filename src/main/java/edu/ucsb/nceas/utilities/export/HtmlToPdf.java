 ...
 */
package edu.ucsb.nceas.utilities.export;
...
public class HtmlToPdf {
	 ...
	 */
	public static void export(String inputFilePath, String outputFile) throws IOException, DocumentException {
        OutputStream os = new FileOutputStream(outputFile);
        
        File inputFile = new File(inputFilePath);
        //File tidyFile = new File(inputFile + ".tidy");
        File tidyFile = File.createTempFile("tidy_", ".html", inputFile.getParentFile());
        OutputStream tidyOut = new FileOutputStream(tidyFile);
        
        Tidy tidy = new Tidy();
        tidy.setXHTML(true);
        tidy.parse(new FileInputStream(inputFilePath), tidyOut);
